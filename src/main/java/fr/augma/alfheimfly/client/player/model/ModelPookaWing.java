...
public class ModelPookaWing extends ModelWingsBase {
	...
	public ModelPookaWing() {
		textureWidth = 64;
		textureHeight = 64;
		
		mid = new ModelRenderer(this);
		mid.setRotationPoint(0.75F, 0.75F, 0.25F);
		mid.cubeList.add(new ModelBox(mid, 1, 18, -3.75F, -1.75F, 2.25F, 6, 8, 0, 0.0F, true));
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 2, 27, -15.75F, 1.1F, 0.9822F, 16, 4, 0, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(1.0F, 0.0F, -2.0F);
		droitetop.addChild(cube_r2);
		setRotation(cube_r2, 0.0F, 0.2618F, -0.6545F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 1, 1, -25.2F, -5.3941F, 1.9576F, 22, 7, 0, 0.0F, false));
		...
		cube_r3.setRotationPoint(2.25F, 1.85F, 2.1F);
		gauchetop.addChild(cube_r3);
		setRotation(cube_r3, 0.0F, -0.2182F, 0.9599F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 2, 27, -0.25F, 1.1F, 0.9822F, 16, 4, 0, 0.0F, true));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-1.0F, 0.0F, 0.1F);
		gauchetop.addChild(cube_r4);
		setRotation(cube_r4, 0.0F, -0.2618F, 0.6545F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 1, 1, 2.5F, -5.4941F, 1.9576F, 22, 7, 0, 0.0F, true));
	}
	...
	public void render(EntityPlayer p) {
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(AlfheimClient.getWings(4));
		mid.render(SCALE);
	}
}
